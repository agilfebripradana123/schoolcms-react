...
export default function SettingsCategoryPage({
    ...
    loadGroup(group)
      .then((res) => {
        ...
        for (const setting of res.data) {
          initial[setting.key] = formatFieldValue(setting);
        }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      /*
       * Jika yang disimpan adalah Appearance,
       * ambil ulang setting Appearance agar perubahan
       * langsung diterapkan ke seluruh aplikasi.
       */
      if (group === "appearance") {
      ...
      /*
       * Reload data form dari database.
       */
