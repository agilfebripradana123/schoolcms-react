...
export const settingsCategories: SettingsCategoryConfig[] = [
  {
    ...
    fields: [
      ...
      { key: "school_name", label: "Nama sekolah", type: "string" },
      {
        ...
        type: "file",
        description:
          "Upload file belum didukung backend — diisi via nilai teks/path.",
      },
      {
        key: "favicon",
        label: "Favicon",
...

  {
    ...
    fields: [
      ...
      { key: "smtp_password", label: "Password", type: "password" },
      {
        ...
        type: "string",
        description:
          "Opsi TLS/SSL belum disediakan backend — diisi sebagai teks.",
      },
      {
    ...
    fields: [
      {
        ...
        type: "string",
        description:
          "Pilihan provider belum disediakan backend — diisi sebagai teks.",
      },
      {
    ...
    fields: [
      {
        ...
        type: "string",
        description:
          "Pilihan gateway belum disediakan backend — diisi sebagai teks.",
      },
      {
        key: "payment_mode",
        label: "Mode",
        type: "string",
        description:
          "Mode sandbox/live belum disediakan backend — diisi sebagai teks.",
      },
      {
        key: "payment_api_key",
        label: "API key",
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "string",
        description:
          "Pilihan storage belum disediakan backend — diisi sebagai teks.",
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Primary color",
        type: "color",
        description: "Pilih warna utama aplikasi.",
      },
      {
        key: "sidebar_behavior",
        label: "Sidebar behavior",
        type: "select",
        description: "Pilih perilaku sidebar pada desktop.",
        options: [
