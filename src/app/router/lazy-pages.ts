...
export const StudentPortalPage = lazy(() => import("@/portal/student/pages/StudentPortalPage"));
export const StudentProfilePage = lazy(() => import("@/portal/student/pages/StudentProfilePage"));
export const StudentGradesPage = lazy(() => import("@/portal/student/pages/StudentGradesPage"));
export const StudentSchedulePage = lazy(() => import("@/portal/student/pages/StudentSchedulePage"));
export const StudentAttendancePage = lazy(() => import("@/portal/student/pages/StudentAttendancePage"));
export const StudentFinanceSummaryPage = lazy(() => import("@/portal/student/pages/StudentFinanceSummaryPage"));
export const StudentBillingsPage = lazy(() => import("@/portal/student/pages/StudentBillingsPage"));
export const StudentPaymentsPage = lazy(() => import("@/portal/student/pages/StudentPaymentsPage"));
export const StudentTransactionsPage = lazy(() => import("@/portal/student/pages/StudentTransactionsPage"));
...
export const StudentNotificationsPage = lazy(() => import("@/portal/student/pages/StudentNotificationsPage"));
