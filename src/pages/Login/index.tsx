      ...
      <div className="relative grid min-h-screen lg:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-10">
            {/* Logo / Header */}
            <div>
              <ShieldCheck className="mb-2 h-8 w-8 text-primary-fixed" />
            ...
            <div>
              ...
              {/* Card with quick note */}
              <Card className="mt-8 border-white/15 bg-white/10 text-white shadow-none backdrop-blur-md">
                <h3 className="font-semibold">Sudah punya akun? Login cepat!</h3>
                <p className="mt-1.5 text-sm">Gunakan akun admin (admin@schoolcms.com) untuk mulai.</p>
              </Card>
            </div>

            {/* Footer */}
            <p className="text-xs text-slate-400">
              © 2026 SchoolCMS. Dibuat untuk dunia pendidikan.
            </p>
          </div>
        </section>
        ...
        <section className="flex items-center justify-center px-4 py-8 lg:px-12">
          <div className="w-full max-w-md">
            ...
            {/* Welcome */}
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-slate-900">Halo! Selamat datang</h1>
              <p className="mt-2 text-sm text-slate-500">Masukkan akun Anda untuk masuk ke dashboard.</p>
            </div>
            ...
            <p className="mt-6 text-center text-xs text-slate-400">
              Demo: admin@schoolcms.com / password
            </p>
          </div>
        </section>
      </div>
