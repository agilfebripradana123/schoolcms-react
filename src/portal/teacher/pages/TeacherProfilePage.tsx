...
function InfoRow({ icon: Icon, label, value }: InfoRowProps) {
  return (
    <div className="flex items-start gap-3">
      <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary-container/15 text-primary">
...
export default function TeacherProfilePage() {
  ...
  return (
    <PageContainer>
      ...
      <Card className="mb-6">
        <CardBody>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <div className="min-w-0">
              <h2 className="text-xl font-bold text-primary">{user?.name || "Guru"}</h2>
      ...
      <Card>
        <CardBody>
          <h3 className="text-sm font-semibold text-secondary">Data Guru</h3>
          ...
          <div className="mt-4 p-12 text-center">
            ...
            <p className="mt-3 text-sm font-semibold text-secondary">Data guru belum tersedia</p>
